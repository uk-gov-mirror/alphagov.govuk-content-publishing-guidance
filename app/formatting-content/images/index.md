...
When you’re ready to add images to your content, read the publishing guidance for your content type for instructions.
...
use black and white rather than colour Include a detailed explanation of the processes and relationships explained in the diagram in the body text. This is helpful for users who cannot see the diagram.
Infographics
...
Some government organisations have public photo libraries (such as the the Government Digital Service (GDS) Flickr account). If you do not have access to a photo library, try using:

Flickr Creative Commons pages – go to the advanced search section, select the dropdown by ‘Any license’ and change it to ‘All creative commons’
Google Images - search for an image, and then select ‘Tools’ and change the ‘Usage Rights’ dropdown to ‘Creative Commons licences’
